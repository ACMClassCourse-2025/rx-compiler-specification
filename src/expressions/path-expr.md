...
A function path serves as a call target. In valid programs, Box/Vec constructors are calls to a [PathExpression] whose container segment carries [GenericArgs]; omitting the type argument is [undefined behavior](../heap.md#builtin-signatures).
