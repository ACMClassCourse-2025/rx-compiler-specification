...
lifetimes. Lifetime names occupy their own namespace. Their declarations,
uses, and bounds satisfy the [lifetime validity contract](../references.md#lifetime-validity).
