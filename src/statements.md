...
Binding visibility and shadowing follow [Names](names.md#settled-scope-rules). A let binding that collides with a visible unqualified const name is course UB; see the [constant-name collision guarantee](undefined-behavior.md#constant-name-collisions).
