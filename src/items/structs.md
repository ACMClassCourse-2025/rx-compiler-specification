...
A struct declaration gives a name, optional lifetime parameters and bounds, and a brace-delimited list of named fields. An optional trailing comma follows the last field. A struct may have [derive attributes](../traits-and-attributes.md#attribute-grammar).
